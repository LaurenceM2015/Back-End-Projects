...
<div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div id="admin-index-form" class=" admin-index-form card p-5 mb-5">
            <?php
      ...
      <h1>Your Profile</h1>
		<form method="post">
            <div class="form-label-group">
                Name:<input name="author_name" type="text" id="inputEmail" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter name"value="<?php echo $_SESSION['author_name']; ?>">
            </div>
            <div class="form-label-group">
            ...
            <div class="form-label-group">
                Password: <input name="author_password" type="password" class="form-control" id="inputPassword" placeholder="Password">
            </div>
          ...
          <button type="submit" name="update" class="btn btn-lg btn-primary text-uppercase">Update</button>
            ...
            if(isset($_POST['update'])){
                ...
                if(empty($author_name) OR empty($author_email) OR empty($author_bio)){
                    ...
                    if(!filter_var($author_email, FILTER_VALIDATE_EMAIL)){
                        ...
                        // checking if password entered is new
