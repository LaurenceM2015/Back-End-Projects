			...
			?>
				...
				<table class="table">
					<thead>
						...
						<th scope="col">Post Feature</th>
						<th scope="col">Post Technologies</th>
				  	...
				  	<tbody>
						<?php
							...
							while($row=mysqli_fetch_assoc($result)){
								...
								$post_feature = $row['post_feature']; 
								$post_technologies = $row['post_technologies']; 
						...
						<tr>
							...
							<td><?php echo $post_feature; ?></td>
							<td><?php echo $post_technologies; ?></td>
							<?php if($_SESSION['author_role']=="admin"){?>
